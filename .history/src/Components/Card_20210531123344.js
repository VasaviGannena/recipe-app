...
const Card = ({ RecipeObj, index }) => {
    ...
    return (
        <div className="card-wrapper mr-5">
            <div "card-top" style={{"background-color": colors[index%5].primaryColor></div>
            <div className="recipe-holder">
                <span className="card-header" style={{ "background-color": "#F2FAF1", "border-radius": "10px" }} > {RecipeObj.Name}></span>
