...
const Card = ({ RecipeObj, index, deleteRecipe, updateListArray }) => {
    ...
    return (
        <div className="card-wrapper row row-cols-1 row-cols-md-3 g-4">
            <div class = " col card-top" style={{"background-color": colors[index%5].primaryColor}}></div>
            <div className="recipe-holder">
                ...
                <p className = "mt-3">{RecipeObj.Ingredients}</p>
